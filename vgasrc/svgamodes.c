...
struct generic_svga_mode svga_modes[] VAR16 = {
    ...
    { 0x19c, { MM_DIRECT, 2048,  1080, 32, 8, 16, SEG_GRAPH } },
    { 0x19d, { MM_DIRECT, 2160,  1080, 32, 8, 16, SEG_GRAPH } },
    { 0x19e, { MM_DIRECT, 2560,  1080, 32, 8, 16, SEG_GRAPH } },
    { 0x19f, { MM_DIRECT, 2560,  1440, 32, 8, 16, SEG_GRAPH } },
    { 0x1a0, { MM_DIRECT, 3200,  1800, 32, 8, 16, SEG_GRAPH } },
    { 0x1a1, { MM_DIRECT, 3440,  1440, 32, 8, 16, SEG_GRAPH } },
    { 0x1a2, { MM_DIRECT, 3840,  1080, 32, 8, 16, SEG_GRAPH } },
    { 0x1a3, { MM_DIRECT, 3840,  1600, 32, 8, 16, SEG_GRAPH } },
    { 0x1a4, { MM_DIRECT, 3840,  2160, 32, 8, 16, SEG_GRAPH } },
    { 0x1a5, { MM_DIRECT, 4096,  2160, 32, 8, 16, SEG_GRAPH } },
    { 0x1a6, { MM_DIRECT, 5120,  2160, 32, 8, 16, SEG_GRAPH } },
    { 0x1a7, { MM_DIRECT, 5120,  2880, 32, 8, 16, SEG_GRAPH } },
    { 0x1a8, { MM_DIRECT, 7680,  4320, 32, 8, 16, SEG_GRAPH } },
    { 0x1a9, { MM_DIRECT, 17280, 4320, 32, 8, 16, SEG_GRAPH } },

    /* quad extended graphics array resolutions */
    { 0x1aa, { MM_DIRECT, 2048,  1152, 32, 8, 16, SEG_GRAPH } },
    { 0x1ab, { MM_DIRECT, 2048,  1536, 32, 8, 16, SEG_GRAPH } },
    { 0x1ac, { MM_DIRECT, 2560,  1600, 32, 8, 16, SEG_GRAPH } },
    { 0x1ad, { MM_DIRECT, 2560,  2048, 32, 8, 16, SEG_GRAPH } },
    { 0x1ae, { MM_DIRECT, 3200,  2048, 32, 8, 16, SEG_GRAPH } },
    { 0x1af, { MM_DIRECT, 3200,  2400, 32, 8, 16, SEG_GRAPH } },
    { 0x1b0, { MM_DIRECT, 3840,  2400, 32, 8, 16, SEG_GRAPH } },
};
